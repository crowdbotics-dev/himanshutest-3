"""
Django settings for himanshutest_3 project.
...
ROOT_URLCONF = 'himanshutest_3.urls'
...
WSGI_APPLICATION = 'himanshutest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himanshutest_3 API",
    "DESCRIPTION": "API documentation for himanshutest_3 App",
    "VERSION": "v1",
}
